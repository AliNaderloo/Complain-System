...
<head>
		...
		$( document ).ready(function() {
			...
			$('#DataTable').DataTable({
			 ...
			 $('.level').change(function() {
			 	...
			 	$con=$(this).parents().parents().find('.consignment:first').text();
	...
	<style type="text/css">
	a div {
		background-color: cadetblue;text-decoration: none;color: white;text-align: center;border-radius: 2px;font-size: 14px;font-weight: normal;height: 25px;
    line-height: 25px;
	}
	...
	<div class="container">
		<table id="DataTable" class=" display hover" cellspacing="0" width="100%">
			...
			<tbody >
				...
				<tr >
					<th class="consignment"><?php echo e($complaints->fld_Consignment); ?></th> </a>
					<th><?php echo e($complaints->getComplaint->fld_Complaints_Subjects); ?></th>
					<th><?php echo e($complaints->fld_Description); ?></th>
					<th>
						
						<select class="form-control level" name="<?php echo e($complaints->fld_Id); ?>" >
					...
					<th>
						<a  href="/Complain/<?php echo e($complaints->fld_Id); ?>" target="_blank">
							<div >
								پیگیری
							</div>
						</a>
