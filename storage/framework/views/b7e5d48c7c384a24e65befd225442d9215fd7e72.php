        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
                ...
                <li>
                  ...
                  <ul class="menu">
                    <li><!-- start message -->
                      <a href="#">
                        <div class="pull-left">
                          <img class="profPic" src="<?php echo e(asset('img/ProfilePics/'.$user->fld_Picture)); ?>" class="img-circle profPic" alt="User Image">
                        </div>
                        <h4>
                          Support Team
            ...
            <li class="dropdown user user-menu">
              <a href="#" id="adminDrop" >
                <img src="<?php echo e(asset('img/ProfilePics/'.$user->fld_Picture)); ?>" class=" profPic user-image" alt="User Image">
                <span class="hidden-xs"><?php echo e($user->fld_Name); ?></span>
              </a>
              <ul id="adminUl" class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="<?php echo e(asset('img/ProfilePics/'.$user->fld_Picture)); ?>" class=" profPic img-circle profPic" alt="User Image">
                  <p>
                    <?php echo e($user->fld_Name); ?>

                    <small>آخرین لاگین :
                      <?php if(!is_null(session('lastLogin'))): ?>
                      <?php echo e(jDate::forge( session('lastLogin'))->ago()); ?>
  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-right image">
        <img src="<?php echo e(asset('img/ProfilePics/'.$user->fld_Picture)); ?>" class="img-circle profPic" alt="User Image">
      </div>
      <div class="pull-right info">
        <p><?php echo e($user->fld_Name); ?></p>
