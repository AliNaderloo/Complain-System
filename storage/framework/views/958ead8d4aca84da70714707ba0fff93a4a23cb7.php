  ...
  <table id="DataTable" style="font-size: 14px" class="table direction table-hover dataTable" role="grid" >
    ...
    <tbody>
      ...
      <tr role="row" >
        ...
        <input autocomplete="off"  style="direction:ltr"  type="text" class="form-control" name="Consignment" id="Consignment" <?php if($createSpcCom!=false): ?> value="<?php echo e($createSpcCom); ?>"  <?php endif; ?>  readonly placeholder="بارنامه">
        </div>
        <div class="form-group">
